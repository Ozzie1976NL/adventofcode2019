...
public class IntComputerTests {
    ...
    public void dayOne() {
        ...
        new IntComputer(oppcodeProgramPuzzleOne, inputQueue, outputQueue).run();
        assertEquals(19690720, oppcodeProgramPuzzleOne[0]);
    }

    @Test
    public void test1() {
        long[] memory = {1, 9, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50};
        IntComputer intComputer = new IntComputer(memory, inputQueue, outputQueue);
        intComputer.run();
        assertEquals(3500, intComputer.getMemory()[0]);
    }


    @Test
    public void dayFiveImmediate() {
        long[] memory = {1101, 100, -1, 4, 0};
        IntComputer intComputer = new IntComputer(memory, inputQueue, outputQueue);
        intComputer.run();
        assertEquals(99, intComputer.getMemory()[4]);
    }

    @Test
    public void day9_example1_copy_of_itself() {
        ...
        intComputer.run();
        long[] outputArray = outputQueue.stream().mapToLong(Long::longValue).toArray();
        assertTrue(Arrays.compare(program, outputArray) == 0);
    }
    ...
    @Test
    public void day9_example3_output_large_number_in_the_middle() {
        IntComputer.debug = true;
