...
class HullPaintingRobotTest extends Specification {
    ...
    def "day 11 puzzle 2"() {
        ...
        when:
        def panelsPainted = hullPaintingRobot.run(HullPaintingRobot.Color.WHITE)
        hullPaintingRobot.drawPoints()
